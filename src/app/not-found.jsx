...
const NotFound = () => {
    return (
        <Container className='felx h-full items-center pt-20 sm:pt-24 lg:pt-32'>
            <FadeIn className='flex flex-col items-center'>
                ...
                <Link href='/' className='mt-4 text-base font-semibold text-neutral-950 transition hover:text-neutral-700'>
                    Go to the home page
                </Link>
            </FadeIn>
        </Container>
